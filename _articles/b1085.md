...
{% include_relative html/b1085.md %}

## 思路

{% include_relative analysis/b1085.md %}

## 代码

[Github最新代码](https://github.com/OliverLew/PAT/blob/master/PATBasic/1085.c)，欢迎交流
...
int main()
{
	...
	for (Student **p = stu; p < stu + N; p++) {
		...
		if (!*(p + 1) || strcmp((*p)->school, (*(p + 1))->school)) {                   /* Record into an array */
			sch[M] = schools + M;
