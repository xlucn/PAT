...
title:  "PAT Basic 1095. 解码PAT准考证 (25) (C语言实现)"
categories: Basic
...
{% include_relative html/b1095.md %}

## 思路

{% include_relative analysis/b1095.md %}

## 代码

[Github最新代码](https://github.com/OliverLew/PAT/blob/master/PATBasic/1095.c)，欢迎交流
...
int main()
{
	...
	for (int i = 0; i < N; i++) {
		...
		sscanf(info[i].string, "%1s%3d%6d%3d",
				info[i].level,
				&info[i].room,
				&info[i].date,
				&info[i].id);
