...
Each input file contains one test case, which gives a positive NN (\le 10^5≤10
​5
​​ ) followed by a permutation sequence of {0, 1, ..., N-1N−1}. All the numbers in a line are separated by a space.
